...
export interface FitCoinTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface FitCoinToken extends BaseContract {
  connect(runner?: ContractRunner | null): FitCoinToken;
  waitForDeployment(): Promise<this>;

  interface: FitCoinTokenInterface;
  ...
  logActivity: TypedContractMethod<
    [activityName: string, tokensToEarn: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  redeemReward: TypedContractMethod<
    [rewardName: string, tokensToBurn: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  filters: {
    "ActivityCompleted(address,string,uint256,uint256)": TypedContractEvent<
      ActivityCompletedEvent.InputTuple,
      ActivityCompletedEvent.OutputTuple,
      ActivityCompletedEvent.OutputObject
    >;
    ...
    "RewardRedeemed(address,string,uint256,uint256)": TypedContractEvent<
      RewardRedeemedEvent.InputTuple,
      RewardRedeemedEvent.OutputTuple,
      RewardRedeemedEvent.OutputObject
    >;
